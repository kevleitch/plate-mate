...
<body>
	...
	<div class="container container-main">
		<div class="container" id="singlerecipe-app">
			<singlerecipe :results="results" :wresults="wresults" :checkeditems="checkeditems" :cid="cid"></singlerecipe>
		</div>
	</div>
	<div class="container container-main">		
		<div class="container" id="recipeslike-app">
			<recipeslike :results="results" :cid="cid"></recipeslike>
		</div>
	</div>
	
	<div class="container container-main">		
		<div class="container" id="external-app">
			<externalrecipes :results="results" :cid="cid"></externalrecipes>
		</div>
	</div>
	...
	<script src="assets/js/single-recipe.js"></script>
